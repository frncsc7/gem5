...
system.cpu.icache = L1ICache(options) # Passing options for configuration
system.cpu.dcache = L1DCache(options) # Passing options for configuration
...
system.l2cache = L2Cache(options) # Passing options for configuration
